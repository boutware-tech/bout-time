...
/**
 * A class to display the bouts by mat with a chart.
 */
public class BoutsByMatChart extends org.jfree.chart.ChartPanel {
     ...
     * @deprecated
     */
    public BoutsByMatChart() {this(null);}

    public BoutsByMatChart(BoutTimeView v) {
        super(null);
        this.view = v;
        initComponents();
    }
    ...
    public void updateStats() {
        ...
        if ((matValues != null) && !matValues.isEmpty()) {
            ...
            for (String s : sSet) {
                int count = dao.getBoutsByMat(s).size();

                dataset.setValue(count, "Mat", s);
            }
        }

        JFreeChart chart = ChartFactory.createBarChart("Bouts by Mat",
