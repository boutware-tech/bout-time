...
public class Bracket16BoutMaker {
    ...
    protected Bout r1b7;    protected Bout r1b8;    protected Bout r2b1;
    protected Bout r2b2;    protected Bout r2b3;    protected Bout r2b4;
    protected Bout r2b5;    protected Bout r2b6;    protected Bout r2b7;
    protected Bout r2b8;    protected Bout r3b1;    protected Bout r3b2;
    protected Bout r3b3;    protected Bout r3b4;    protected Bout r4b1;
    protected Bout r4b2;    protected Bout r4b3;    protected Bout r4b4;
    protected Bout r5b1;    protected Bout r5b2;    protected Bout r6b1;
    protected Bout r6b2;    protected Bout r6b3;    protected Bout r7b1;
    ...
    protected List<Bout> makeRound4Bouts(Group g, Wrestler d) {
        ...
        // Back-side
        ////////////
        isBye = ((r1b1.isBye() && r1b2.isBye() && r2b4.isBye()) ||
                 (r1b3.isBye() && r1b4.isBye() && r2b3.isBye())) ? true : false;
        byeCount += (isBye) ? 1 : 0;
        this.r4b3 = new Bout(d, d, g, Bout.ROUND_4, 3, "", isBye, true);
        bList.add(this.r4b3);

        isBye = ((r1b5.isBye() && r1b6.isBye() && r2b2.isBye()) ||
                 (r1b7.isBye() && r1b8.isBye() && r2b1.isBye())) ? true : false;
        byeCount += (isBye) ? 1 : 0;
    ...
    protected List<Bout> makeRound5Bouts(Group g, Wrestler d) {
        ...
        isBye = (r4b1.isBye() ||
                (r1b1.isBye() && r1b2.isBye() && r1b3.isBye() && r1b4.isBye() &&
                 r2b3.isBye() && r2b4.isBye())) ? true : false;
        byeCount += (isBye) ? 1 : 0;
        ...
        isBye = (r4b2.isBye() ||
                (r1b5.isBye() && r1b6.isBye() && r1b7.isBye() && r1b8.isBye() &&
                 r2b1.isBye() && r2b2.isBye())) ? true : false;
        byeCount += (isBye) ? 1 : 0;
    ...
    protected List<Bout> makeRound6Bouts(Group g, Wrestler d, boolean doFifthPlace) {
        ...
        isBye = ((red == null) || (green == null)) ? true : false;
        byeCount += (isBye) ? 1 : 0;
        this.r6b1 = new Bout(red, green, g, Bout.ROUND_6, 1, Bout.FIRST_PLACE, isBye, false);
        bList.add(this.r6b1);
        ...
        byeCount += (isBye) ? 1 : 0;
        this.r6b2 = new Bout(d, d, g, Bout.ROUND_6, 2, Bout.THIRD_PLACE, isBye, true);
        bList.add(this.r6b2);
        ...
        if (doFifthPlace && (numWrestlers > 5)) {
            ...
            byeCount += (isBye) ? 1 : 0;
            this.r6b3 = new Bout(red, green, g, Bout.ROUND_6, 3, Bout.FIFTH_PLACE, isBye, true);
            bList.add(this.r6b3);
        } else {
            this.r6b3 = null;
        }
    ...
    protected List<Bout> makeRound7Bouts(Group g, Wrestler d) {
        ...
        this.r7b1 = new Bout(d, d, g, Bout.ROUND_7, 1, Bout.SECOND_PLACE, false, true);
        bList.add(this.r7b1);
    ...
    protected void linkBouts() {
        ...
        // Round 6 : front-side (championship)
        this.r6b1.setWinnerNextBout(null);  // champion
        this.r6b1.setLoserNextBout(this.r7b1);

        // Round 6 : back-side (3rd place)
        this.r6b2.setWinnerNextBout(this.r7b1);
        this.r6b2.setLoserNextBout(null);   // 4th place
    }
}
