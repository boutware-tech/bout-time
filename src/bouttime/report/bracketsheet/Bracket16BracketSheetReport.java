...
public class Bracket16BracketSheetReport extends CommonBracketSheet {
    ...
    protected boolean drawBracket(PdfContentByte cb, BaseFont bf, Dao dao,
        ...
        if ((b != null) && !b.isBye() && doBoutNumbers) {
            BracketSheetUtil.drawBoutNum(cb, bf, x + (height / 2) - 10, y + (length / 2),
        ...
        if (b != null) {
            ...
            wa = b.getRed();
            if (wa != null) {
                BracketSheetUtil.drawString(cb, bf, x - 3, y + 8, 10,
            ...
            if (wa != null) {
                BracketSheetUtil.drawString(cb, bf, x + round2height + 10,
                        y + 8, 10, wa.getLastName(), 90, wa.isScratched());
            }
        }
        ...
        if (b != null) {
            if (!b.isBye() && doBoutNumbers) {
                BracketSheetUtil.drawBoutNum(cb, bf, x + ((round4height / 2) + 10),
                        y + ((round4length / 2)) - 10, 20, 20, 0, 6, 12, 1, 0, b.getBoutNum(), 90);
            }
        ...
        if (b != null) {
            ...
            if (wa != null) {
                BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_RIGHT,
                        x - 3, y + round2length - 12, 10, wa.getLastName(), 90);
            }

            wa = b.getGreen();
            if (wa != null) {
                BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_RIGHT,
                        x + round2height + 10, y + round2length - 12, 10, wa.getLastName(), 90);
            }
        }
        x = x + (2 * round2height);
        BracketSheetUtil.drawFishTailDown(cb, x, y, round2length, round2height, 1, 0);
        ...
        if (b != null) {
            ...
            if (wa != null) {
                BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_RIGHT,
                        x + consRound4height + 10, y + round2length - 12, 10, wa.getLastName(), 90);
            }
        }
        ...
        if (b != null) {
            ...
            if (wa != null) {
                BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_RIGHT,
                        x + consRound5height + 10, y + round2length - 12, 10, wa.getLastName(), 90);
            }
        }
        ...
        if (b != null) {
            ...
            if (wa != null) {
                BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_RIGHT,
                        x + consRound6height + 10, y + round2length - 12, 10, wa.getLastName(), 90);
            }
        }
        ...
        if (b != null) {
            ...
            if (wa != null) {
                BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_RIGHT,
                        x - 18, y + round2length - 12, 10, wa.getLastName(), 90);
            }
        }
            ...
            if (b != null) {
                ...
                if (wa != null) {
                    BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_LEFT,
                            x - 3, y + 8, 10, wa.getLastName(), 90);
                }

                wa = b.getGreen();
                if (wa != null) {
                    BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_LEFT,
                            x + height2 + 10, y + 8, 10, wa.getLastName(), 90);
                }
            }
        ...
        if (dao.isFifthPlaceEnabled()) {
            ...
            if (b != null) {
                ...
                if (wa != null) {
                    BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_RIGHT,
                            x - 3, y + round2length - 6, 10, wa.getLastName(), 90);
                }

                wa = b.getGreen();
                if (wa != null) {
                    BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_RIGHT,
                            x + height2 + 10, y + round2length - 6, 10, wa.getLastName(), 90);
                }
            }
            ...
            if (b != null) {
                ...
                if (wa != null) {
                    BracketSheetUtil.drawStringAligned(cb, bf, PdfContentByte.ALIGN_RIGHT,
                            x - 3, y + finalLength - 12, 10, wa.getLastName(), 90);
                }
            }
            x += 15; // padding below the line
            mid = y + (finalLength / 2);
