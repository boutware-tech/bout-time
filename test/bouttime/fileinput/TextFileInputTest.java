...
public class TextFileInputTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        bufferedWriter.write("David,Robinson,Open,5,88,A,Spurs,SW"); bufferedWriter.newLine();
        bufferedWriter.write("Tim,Duncan,Open,4,99,A,Spurs,SW"); bufferedWriter.newLine();
        bufferedWriter.write("Tony,Parker,Rookie,1,77,Spurs,SW"); bufferedWriter.newLine();
    ...
    public void testGetInputFromFile_Map_Dao() {
        ...
        assertEquals("8", fiConfig.getGeo());
